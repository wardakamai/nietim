      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                { label: 'EN590 10PPM Diesel', to: '/products/en590-diesel' },
                { label: 'Jet A-1 Aviation Fuel', to: '/products/jet-a1' },
                { label: 'D6 Virgin Fuel Oil', to: '/products/d6-fuel-oil' },
                { label: 'Aviation Gasoline', to: '/products' },
                { label: 'Base Oil', to: '/products' },
                { label: 'Crude Oil', to: '/products' },
              ].map((product) => (
