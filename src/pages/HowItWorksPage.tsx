...
export default function HowItWorksPage() {
  ...
  return (
    <div className="min-h-screen pt-28 lg:pt-36">
      <SEO
        title="How Petroleum Transactions Work | NIETIM LLP"
        description="Step-by-step guide to LOI submission, KYC, FCO, banking instruments, and final product delivery in a verified petroleum trade transaction."
