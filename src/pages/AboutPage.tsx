...
export default function AboutPage() {
  return (
    <div className="min-h-screen pt-28 lg:pt-36">
      <SEO
        title="About NIETIM LLP | Verified Oil & Gas Trade Mandate"
        description="Learn how NIETIM LLP operates as a direct mandate and authorized petroleum trade facilitator with 15+ years in global energy markets."
        canonical="/about"
      />
      {/* Hero */}
