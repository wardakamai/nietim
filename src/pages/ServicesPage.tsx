...
export default function ServicesPage() {
  return (
    <div className="min-h-screen pt-28 lg:pt-36">
      <SEO
        title="Oil & Gas Trading Company Services | NIETIM LLP"
        description="Full-service oil and gas trading company offering trade facilitation, mandate representation, KYC/AML compliance, and transaction support."
        canonical="/services"
      />
      {/* Hero */}
