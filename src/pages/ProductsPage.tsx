...
export default function ProductsPage() {
  return (
    <div className="min-h-screen pt-28 lg:pt-36">
      <SEO
        title="Petroleum Products | EN590, Jet A1, D6 | NIETIM LLP"
        description="NIETIM LLP facilitates bulk petroleum product transactions — EN590 diesel, Jet A1 aviation fuel, and D6 residual fuel oil. Request a quote."
        canonical="/products"
      />
      {/* Hero */}
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <FadeUpSection>
            ...
            <p className="text-gray-300 text-xl max-w-3xl mx-auto leading-relaxed">
              NIETIM LLP is an established petroleum products supplier and wholesale fuel supplier facilitating bulk EN590 diesel, Jet A-1 aviation fuel, and D6 virgin residual fuel oil transactions for qualified international buyers.
            </p>
          </FadeUpSection>
        </div>
      </section>
              ...
              >
                ...
                <div className="p-8 md:p-10">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 mt-8">
                    ...
                    <motion.div whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }} transition={{ type: 'spring', stiffness: 400, damping: 25 }}>
                      <Link to={product.subpage} className="text-[#c9a84c] px-8 py-3.5 rounded-xl text-sm font-bold inline-flex items-center gap-2 border border-[#c9a84c]/20 hover:border-[#c9a84c]/50 transition-colors">
