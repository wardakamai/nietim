...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen pt-28 lg:pt-36">
      <SEO
        title="Contact NIETIM LLP | Submit LOI or Buyer Inquiry"
        description="Submit a LOI, ICPO, or general buyer inquiry. NIETIM LLP responds within 24–48 hours. WhatsApp available for urgent contacts."
        canonical="/contact"
      />
      {/* Hero */}
