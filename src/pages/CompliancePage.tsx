...
export default function CompliancePage() {
  return (
    <div className="min-h-screen pt-28 lg:pt-36">
      <SEO
        title="KYC & AML Compliance | Vetted Oil Trade | NIETIM LLP"
        description="NIETIM LLP enforces strict KYC, AML, and global sanctions screening on all parties. FATF-aligned, OFAC/UN/EU screened, GDPR compliant."
