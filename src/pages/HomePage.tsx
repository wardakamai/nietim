...
const products = [
  { name: 'EN590 10PPM', type: 'Ultra-Low Sulphur Diesel', origin: 'European Refineries (ARA, Rotterdam)', delivery: 'FOB / CIF / TTO', subpage: '/products/en590-diesel' },
  { name: 'Jet A-1', type: 'Aviation Turbine Fuel', origin: 'Europe / Middle East Refineries', delivery: 'FOB / CIF / CIP', subpage: '/products/jet-a1' },
  { name: 'D6 Virgin', type: 'Residual Fuel Oil', origin: 'Russian Federation', delivery: 'FOB / TTO', subpage: '/products/d6-fuel-oil' },
];
...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen">
      <SEO
        title="NIETIM LLP | Petroleum Products Supplier & Oil Mandate"
        description="Global petroleum products supplier and authorized oil trade mandate. Verified EN590, Jet A1, and D6 transactions across 42+ countries."
        canonical="/"
      />
      {/* ===== HERO SECTION ===== */}
              ...
              <motion.div key={product.name} variants={staggerItem}>
                <TiltCard className="relative bg-gradient-to-br from-[#0a1628] to-[#102548] rounded-2xl p-8 glow-border h-full">
                  ...
                  <div className="border-t border-[#c9a84c]/10 pt-5 flex items-center justify-between">
                    <Link to={product.subpage} className="text-[#c9a84c] text-sm font-bold hover:text-[#e2c06e] transition-colors">
                      View Specifications →
                    </Link>
